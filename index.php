...
?><!DOCTYPE html><html><head><meta name=viewport content="width=device-width,initial-scale=1,user-scalable=no"><link rel=stylesheet href=//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css integrity=sha384-1q8mTJOASx8j1Au+a5WDVnPi2lkFfwwEAa8hDDdjZlpLegxhjVME1fgjWPGmkzs7 crossorigin=anonymous></head><title>Index of <?
$parent = '/';
?><?
...
?><?
endforeach;
?><?= $parent; ?></title><body><div class=container-fluid><h1><a href=https://<?= $this_domain ?>><?= $this_domain ?></a><?
foreach ($dir_name as $dir => $name):
?><?
...
?><?
endforeach;
?></h1></div><div class=table-responsive><table class=table><thead><tr><th>Name</th><th>Size</th><th>Date modified</th></tr></thead><tbody><?
if ($folder_list):
?><?
    foreach ($folder_list as $item):
?><tr><th><a href=<?= $item['name'] ?>/><?= $item['name'] ?></a></th><th><?= $item['size']['num'] ?><?= $item['size']['str'] ?></th><th><?= time_ago($item['mtime']) ?> ago</th></tr><?
    endforeach;
?><?
endif;
?><?
...
?><tr><th><a href=<?= $item['name'] ?>.<?= $item['ext'] ?>><?= $item['name'] ?>.<?= $item['ext'] ?></a></th><th><?= $item['size']['num'] ?><?= $item['size']['str'] ?></th><th><?= time_ago($item['mtime']) ?> ago</th></tr><?
    endforeach;
?><?
endif;
?></table></div></body></html>
